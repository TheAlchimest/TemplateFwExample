...
namespace TemplateFw.Shared.Helpers.SqlDataHelpers
{
    ...
    public static class SqlParameterExtensions
    {
        ...
        public static void AddParameter(this List<SqlParameter> parameters, string parameterName, object value)
        {
        ...
        public static List<SqlParameter> ToSqlParamsList(this object obj, SqlParameter[] additionalParams = null, List<string> igoredParameters = null)
        {
            ...
            props.ForEach(p =>
            {
                ...
                if (igoredParameters != null && igoredParameters.Contains(p.Property.Name))
                    return;
